...
const APPS = [
  ...
  { id:'mirsad',   ax:'staff',     ic:'usercheck', t:'مِرصاد — تغيبات الأطر',      d:'جرد وتتبّع تغيبات الأطر التربوية والإدارية وإصدار الجذاذات الشهرية.', img:'app10', guide:'mirsad' },
  { id:'taslim',   ax:'staff',     ic:'handover',  t:'محضر تسليم المهام',          d:'تحرير وطبع محاضر تسليم وتسلّم المهام في التعليم الابتدائي وفق المسطرة الجاري بها العمل.', img:'app11', guide:'taslim' },

  { id:'sijil',    ax:'mail',      ic:'book',      t:'سجل المراسلات',              d:'تسجيل الصادر والوارد، وطبع أوراق الإرسال والإحصائيات السنوية للمراسلات.', img:'app12', guide:'sijil' },
  { id:'wathaiq',  ax:'mail',      ic:'send',      t:'مراسلات الوثائق المدرسية',   d:'تتبّع طلبات ومراسلات الوثائق المدرسية من الطلب إلى التسليم دون ضياع.', img:'app13', guide:'wathaiq' },

  { id:'mali',     ax:'finance',   ic:'coins',     t:'التدبير المالي للجمعية',     d:'مداخيل ومصاريف جمعية دعم مدرسة النجاح، مع الموازنة والتقارير المالية.', img:'app14', guide:'mali' },
  { id:'tamin',    ax:'finance',   ic:'shield',    t:'التأمين المدرسي',            d:'إعداد لوائح التأمين المدرسي وتتبّع الأداءات والمبالغ المحصّلة قسمًا قسمًا.', img:'app15', guide:'tamin' },
  { id:'jard',     ax:'finance',   ic:'box',       t:'جرد ممتلكات المؤسسة',        d:'منظومة جرد ممتلكات المؤسسة التعليمية وتتبّع حالتها وحركتها بين القاعات.', img:'app16' },

  { id:'mashrou',  ax:'lead',      ic:'target',    t:'مِرآة — مشروع المؤسسة',      d:'إعداد وتقديم مشروع المؤسسة المندمج ومؤشراته وبطاقات أنشطته.', img:'app17', guide:'mashrou' },
  { id:'sabora',   ax:'lead',      ic:'gauge',     t:'السبورة المرجعية',           d:'تدبير المعطيات المرجعية للمؤسسة ولوحات قيادتها في واجهة واحدة.', img:'app18', guide:'sabora' },
  { id:'dalil',    ax:'lead',      ic:'map',       t:'دليل المؤسسات التعليمية',    d:'بحث في المؤسسات العمومية بالمغرب: العناوين والهواتف والأكواد والنيابات.', img:'app19' }
];
...
const VIDEOS = [
  { id:'platform-full', yt:'',   app:null,       t:'الجولة الكاملة في المنصّة الموحّدة',  d:'عرض شامل للمنصّة من التثبيت إلى الاستعمال اليومي، تطبيقًا تطبيقًا.', dur:'71:18', len:4278, img:'cover', ax:'lead',      featured:true },
  { id:'taqwim',        yt:'',   app:'taqwim',   t:'مِرصاد التقويم — تتبّع الكفايات',      d:'من رفع ملفات الشبكات إلى لوحة القيادة وخطة الدعم الجاهزة للطبع.',    dur:'2:54',  len:174,  img:'app05',  ax:'assess' },
  { id:'daam',          yt:'',   app:'daam',     t:'استثمار نتائج الروائز — الدعم الممتد', d:'قراءة الرائز البعدي وتحديد الفئات المستهدفة وحجم الدعم المطلوب.',   dur:'1:59',  len:119,  img:'app07',  ax:'assess' },
  { id:'shawahid',      yt:'',   app:'shawahid', t:'مُحرِّر شواهد العمل',                 d:'تحرير شهادة عمل بالعربية أو الفرنسية وطبعها في أقل من دقيقة.',       dur:'1:54',  len:114,  img:'app09',  ax:'staff' },
  { id:'tarl',          yt:'',   app:'tarl',     t:'تحليل روائز دعم التعلّمات الأساس',    d:'تحويل ملف الروائز الخام إلى مؤشرات ومجموعات دعم قابلة للتنفيذ.',     dur:'1:42',  len:102,  img:'app06',  ax:'assess' },
  { id:'tartib',        yt:'',   app:'tartib',   t:'ترتيب الأساتذة وتحديد الفائض',        d:'تطبيق المعايير الرسمية للترتيب واستخراج المحضر النهائي.',            dur:'1:36',  len:96,   img:'app08',  ax:'staff' },
  { id:'hisas',         yt:'',   app:'hisas',    t:'توزيع الحصص بمؤسسات الريادة',         d:'بناء جدول الحصص الأسبوعي ومعالجة التعارضات آليًّا.',                 dur:'1:24',  len:84,   img:'app01',  ax:'schooling' }
];
...
/* ═══════════════════════════════════════════════════════════
   طلب نسخة من المنصّة
   ───────────────────────────────────────────────────────────
   المنصّة لا تُنزَّل من الموقع مباشرةً؛ تُطلب بالبريد.
   كل زرّ طلب في الصفحات يحمل السمة data-request ويكتفي بـ
   mailto بسيط، ثم يرقّيه site.js إلى هذا الرابط المعبَّأ مسبقًا
   (فيعمل الزرّ حتى لو عُطِّل جافاسكريبت).
   لتغيير نصّ الرسالة أو عنوان المراسَلة، عدِّل هنا فقط.
   ═══════════════════════════════════════════════════════════ */
const REQUEST_MAIL = 'amahanamine0@gmail.com';

/* ═══════════════════════════════════════════════════════════
   استمارة طلب نسخة — إلى أين تُرسَل؟
   ───────────────────────────────────────────────────────────
   endpoint فارغ  → تُفتح رسالة بريد معبّأة بكل حقول الاستمارة
                    في برنامج بريد المستعمل. تعمل بلا أي إعداد،
                    لكنّ المستعمل يجب أن يضغط «إرسال» بنفسه.

   endpoint مملوء → تُرسَل الطلبات إليك مباشرةً في الخلفية.
                    الخيارات المجّانية:

   • استمارات جوجل (بلا حدّ، والنتائج في جدول Sheets — الأنسب
     لإحصاء المؤسسات): أنشئ استمارة بالحقول السبعة، ثم من
     «إرسال ← <>» انسخ رابط التضمين، واستبدل نهايته
     /viewform بـ /formResponse. لمعرفة أسماء الحقول:
     افتح الاستمارة ← زرّ أيمن ← «فحص» ← ابحث عن entry.123456
     لكل حقل. ثم ضع noCors: true.

   • Web3Forms (250 طلبًا شهريًّا، تصل بريدًا):
     endpoint: 'https://api.web3forms.com/submit'
     وأضف مفتاحك في extra: { access_key: 'xxx' }

   • Formspree: endpoint: 'https://formspree.io/f/xxxx'
   ═══════════════════════════════════════════════════════════ */
const FORM = {
  endpoint: '',        // اتركه فارغًا ليعمل عبر البريد
  noCors:   false,     // true مع استمارات جوجل
  extra:    {},        // حقول ثابتة تُرسَل مع كل طلب (مثل access_key)

  /* أسماء الحقول عند الخدمة. مع جوجل استبدلها بـ 'entry.123456' */
  fields: {
    name:      'name',
    school:    'school',
    direction: 'direction',
...
/* تسميات الحقول — تُستعمل في الاستمارة وفي نصّ رسالة البريد */
const FORM_LABELS = {
  name:      'الاسم الكامل',
  ...
  note:      'ملاحظة أو طلب خاص'
};

const ROLES = ['مدير(ة)', 'متصرف(ة) تربوي', 'إطار إداري', 'أخرى'];
const REQUEST_URL  = 'mailto:amahanamine0@gmail.com?subject=%D8%B7%D9%84%D8%A8%20%D9%86%D8%B3%D8%AE%D8%A9%20%D9%85%D9%86%20%D8%A7%D9%84%D9%85%D9%86%D8%B5%D9%91%D8%A9%20%D8%A7%D9%84%D9%85%D9%88%D8%AD%D9%91%D8%AF%D8%A9%20%D9%84%D9%84%D8%AA%D8%AF%D8%A8%D9%8A%D8%B1%20%D8%A7%D9%84%D9%85%D8%AF%D8%B1%D8%B3%D9%8A&body=%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%0A%0A%D8%A3%D8%B1%D8%BA%D8%A8%20%D9%81%D9%8A%20%D8%A7%D9%84%D8%AD%D8%B5%D9%88%D9%84%20%D8%B9%D9%84%D9%89%20%D9%86%D8%B3%D8%AE%D8%A9%20%D9%85%D9%86%20%D8%A7%D9%84%D9%85%D9%86%D8%B5%D9%91%D8%A9%20%D8%A7%D9%84%D9%85%D9%88%D8%AD%D9%91%D8%AF%D8%A9%20%D9%84%D9%84%D8%AA%D8%AF%D8%A8%D9%8A%D8%B1%20%D8%A7%D9%84%D9%85%D8%AF%D8%B1%D8%B3%D9%8A.%0A%0A%D8%A7%D9%84%D8%A7%D8%B3%D9%85%20%D8%A7%D9%84%D9%83%D8%A7%D9%85%D9%84%3A%0A%D8%A7%D9%84%D9%85%D8%A4%D8%B3%D8%B3%D8%A9%3A%0A%D8%A7%D9%84%D9%85%D8%AF%D9%8A%D8%B1%D9%8A%D8%A9%20%D8%A7%D9%84%D8%A5%D9%82%D9%84%D9%8A%D9%85%D9%8A%D8%A9%3A%0A%D8%A7%D9%84%D8%B5%D9%81%D8%A9%3A%0A%0A%D9%88%D8%B4%D9%83%D8%B1%D9%8B%D8%A7%20%D9%84%D9%83%D9%85.';
